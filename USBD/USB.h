...
/* USB system version */
#define USB_VERSION  31802uL // Format: Mmmrr Example: 31802UL is 3.18b
...
*       Status flags
*/
#define USB_STAT_ATTACHED   (1u << 4)  // F
#define USB_STAT_READY      (1u << 3)  // 8 Set by any bus reset. Is required to go from "Powered" to "Addressed"
#define USB_STAT_ADDRESSED  (1u << 2)  // 4
#define USB_STAT_CONFIGURED (1u << 1)  // 2
#define USB_STAT_SUSPENDED  (1u << 0)  // 1
...
void USB_DRIVER_XHCI_Config(int EnableSuperSpeed, unsigned BurstSize);
